...
manual_pronun_mapping = [
    ...
    (u"^полу(в[её]д)", ur"полу̀\1"),
    (u"^полу(ве́?к)", ur"полу̀\1"),
    (u"^полу(го́?д)", ur"полу̀\1"),
    (u"^полу(им)", ur"по̀лу\1"),
    (u"^полу(килом)", ur"полу̀\1"),
    (u"^полу(ли́тр)", ur"полу̀\1"),
    (u"^полу(лю́?д|челов)", ur"по̀лу\1"),
    (u"^полу(ме́сяц)", ur"полу̀\1"),
    (u"^полу(ме́тр)", ur"полу̀\1"),
    (u"^полу(миллио́н)", ur"полу̀\1"),
    (u"^полу(ос)", ur"по̀лу\1"),
    (u"^полу(остров)", [ur"по̀лу\1", ur"полу\1"]),
    (u"^полу(очк)", ur"полу́\1"),
    (u"^полу(со́тн)", ur"полу́\1"),
    (u"^полу(ты́сяч)", ur"полу́\1"),
    (u"^полу(ча́?с)", ur"полу́\1"),
